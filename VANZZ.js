...
healtawal = 100
potionawal = 1
let lolkey = 'A-BOTZ7' //Daftar Atau Beli Di lolhuman.xyz
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • selldiamond`)
        ...
        //+++ || FAKE TROLI         
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `𝗭𝗘𝗘𝗦𝗘𝗟𝗙𝗕𝗢𝗧`, orderTitle: 'LordVANZZ', sellerJid: '0@s.whatsapp.net'} } }    
...
//━━━━━━━━━━━━━━━[ GAK USAH DI UBAH ]━━━━━━━━━━━━━━━\\
        ...
        //Beli Di http://wa.me/6285824629954
        //Atau https://wa.me/6283159647567
...
//»»»𝘉𝘶𝘵𝘵𝘰𝘯 𝘉𝘢𝘮𝘩 
    ...
    case 'group': case 'gc': case 'grup':     	 
          ...
          sendButton(from, menu, 'Created By VANZZ OFC', but, troli)
          break           
...
${q+=1}.term`)        
          ...
          sendButton(from, pp, 'Created By VANZZ OFC', but, troli)
          break         
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item5.X-ABLabel:⚔️ VANZZ - Botz Owner\n` +
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator VANZZ OFC`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
   ...
   default:
          ...
          sendButton(from, menu, 'Created By VANZZ OFC', but, mek)
          break
          }
